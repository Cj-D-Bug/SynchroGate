...
const RegisterScreen = () => {
  ...
  const validatePassword = (password) => {
    ...
    return {
      ...
      maxLength,
      hasNumber,
      isValid: minLength && maxLength && hasNumber
    };
  };
        ...
        <View style={styles.modalOverlayCenter}>
          <View style={styles.termsModalCard}>
            <View style={styles.termsModalHeader}>
              ...
              <TouchableOpacity
                style={styles.termsModalCloseIcon}
            ...
            <View style={styles.termsModalFooterContainer}>
              <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  eyeIcon: { 
    position: 'absolute', 
    right: 10, 
    top: 23, // Centered: label (12px + 3px margin) + input center (16px) - icon half (10px)
    zIndex: 1,
    justifyContent: 'center',
    alignItems: 'center',
    height: 18,
