...
const styles = StyleSheet.create({
  ...
  fbModalTitle: { fontSize: 20, fontWeight: '600', color: '#050505', marginBottom: 12, textAlign: 'left' },
  fbModalMessage: { fontSize: 15, color: '#65676B', textAlign: 'left', lineHeight: 20 },
